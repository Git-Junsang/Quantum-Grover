//=====================================================================
// tb_dram_bench250.v -- 보드 실측(2026-09-04 K4/H4)과 같은 250쌍 워크로드를
// 통신 계층 없이 Main IP 레벨에서 재현합니다.
//
...
//
// 통신 계층(APB/AHB, C 드라이버)은 다른 사람이 맡기로 했으므로 여기서는
...
// software/rtl_vectors/tools/dump_bench_workload.py --seeds 50 가 만듭니다.
//=====================================================================
`timescale 1ns/1ps
...
`endif
    ...
    // 한 케이스 실행 + CSV 한 줄. bench250_report.py 가 이 형식을 읽습니다.
    task run_one;
        input integer m_idx;
