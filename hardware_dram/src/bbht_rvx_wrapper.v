...
module bbht_rvx_wrapper #(
    ...
    // checkpoint 게이트
    //
    // hardware_bram 과 포트 계약을 맞추기 위해 남겨 둔 신호입니다.
    // hardware_dram 갈래의 Main IP(lpsoc_bbht_grover_main_ip.v, DRAM
    // 전량저장판)는 checkpoint 개념이 아예 없어 이 값을 읽지 않습니다.
    // 자세한 이유는 grover_dram_prep_seq.v 머리말 참고.
    //=================================================================
