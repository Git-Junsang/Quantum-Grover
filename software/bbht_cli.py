...
sys.path.insert(0, __file__.rsplit("/", 2)[0] + "/csr/generated")
...
def main():
    ...
    ap.add_argument("--port", required=True,
                    help="시리얼 장치 (예 /dev/ttyUSB1, COM3). 'mock' 이면 모델")
    ...
    transport = (MockTransport() if args.port == "mock"
                 else SerialTransport(args.port, args.baud, args.timeout))
