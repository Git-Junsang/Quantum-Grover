...
must agree on.  The autonomous K4/H4 policy is an internal Main-IP detail.
"""
...
# 틀려집니다 -- K4/H8 에서 K4/H4 를 거쳐 지금은 K3/H3 입니다. 옛 이름으로
# 부르는 캠페인 스크립트를 위해 계속 받아 주되, 정본 이름은 위의 다섯입니다.
RUN_MODE_ALIASES = {
    "REQUESTED_J_SINGLE": "MANUAL_SINGLE",
    "K4H4_SINGLE": "CKPT_SINGLE",
