...
must agree on. The final K3/H3 policy and comparison-only K4/H4 policy are
internal Main-IP details; both remain available for controlled comparison.
"""
...
# The final board build uses K3/H3.  Keep the previous K4/H4 values named so
# old-board results can still be reproduced as an explicit comparison mode.
V098_CHECKPOINT_K = 3
V098_POLICY_HORIZON = 3
V098_LEGACY_CHECKPOINT_K = 4
V098_LEGACY_POLICY_HORIZON = 4
V098_ENUM_FAIL_DEFAULT = 3
...
RUN_MODES = {
    "REQUESTED_J_SINGLE": (False, False, False),
    "MANUAL_SINGLE": (False, False, False),
    "NORMAL_SINGLE": (True, False, False),
    "K4H4_SINGLE": (True, True, False),
    "K4H8_SINGLE": (True, True, False),
    "K3H3_SINGLE": (True, True, False),
    "K3H3_E4_M2_SINGLE": (True, True, False),
    "NORMAL_ENUM": (True, False, True),
    "K4H4_ENUM": (True, True, True),
    "K4H8_ENUM": (True, True, True),
    "K3H3_ENUM": (True, True, True),
    "K3H3_E4_M2_ENUM": (True, True, True),
}
...
class V098RuntimeConfig:
    ...
    fail_repeat_limit: int = V098_ENUM_FAIL_DEFAULT
    j_target: int = 0
